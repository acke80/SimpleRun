...
import se.umu.christofferakrin.run.controller.result.ResultRecyclerAdapter;
...
public class HistoryFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Thread thread = new Thread(() -> {
            ArrayList<RunEntity> runEntities = (ArrayList<RunEntity>) RunApp.getDatabase().runEntityDao().getAll();
